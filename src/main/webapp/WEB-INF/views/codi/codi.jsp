...
<div id="menu">
	...
	<div id="login-button" class="login-button">
		<a href="loginf">
			<svg class="login-svg" preserveAspectRatio="xMidYMid meet" data-bbox="0 0 50 50" data-type="shape" xmlns="http://www.w3.org/2000/svg" width="5vw" height="5vh" viewBox="0 0 50 50" role="img">
    			<g>
...
<section>
<div class="side-div">
			<a class="side-codi" href="codi" >첫화면</a>
	  		<a class="side-codi"  id="test1" >테스트1</a>
	  		<a class="side-codi"  id="test2" >테스트2</a>
	  		<a class="side-codi"  id="test3" >테스트3</a>	
	  		<script>
	  			$(document).ready(function(){
	  				$('#test1').click(function(){
	  					$('.section-main-div').load('test1');
	  				});
	  				$('#test2').click(function(){
	  					$('.section-main-div').load('test2');
	  				});
	  				$('#test3').click(function(){
	  					$('.section-main-div').load('test3');
	  				});
